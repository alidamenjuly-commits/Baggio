...
const PRODUCTS = [
  {
    ...
    sizes: ['S','M','L','XL','XXL'],
    colors: [
      { name: 'Nero',      hex: '#141412' },
      { name: 'Panna',     hex: '#ede4d0' },
      { name: 'Bosco',     hex: '#2a3a2c' },
      { name: 'Cioccolato', hex: '#4a352a' },
    ],
  },
  {
    id: 'waffle-polo',
    ...
    sizes: ['S','M','L','XL'],
    colors: [
      { name: 'Avorio',  hex: '#ebe0c6' },
      { name: 'Antracite', hex: '#2c2c2a' },
      { name: 'Cammello', hex: '#b58f5f' },
    ],
  },
  {
    id: 'pique-polo',
    ...
    sizes: ['S','M','L','XL','XXL'],
    colors: [
      { name: 'Bianco', hex: '#f2ede0' },
      { name: 'Marino', hex: '#1c2436' },
      { name: 'Nero',   hex: '#141412' },
      { name: 'Salvia', hex: '#7f8a6a' },
    ],
  },
  {
    id: 'silk-blend-polo',
    ...
    sizes: ['S','M','L','XL'],
    colors: [
      { name: 'Champagne', hex: '#d8c89e' },
      { name: 'Notte',     hex: '#0f1416' },
      { name: 'Bordeaux',  hex: '#5a1e26' },
    ],
  },
  {
    id: 'linen-shirt',
    ...
    colors: [
      { name: 'Panna',   hex: '#ede4d0' },
      { name: 'Oliva',   hex: '#5a5c3a' },
      { name: 'Sabbia',  hex: '#c8b898' },
    ],
  },
  {
    id: 'oxford-shirt',
    ...
    colors: [
      { name: 'Bianco', hex: '#f2ede0' },
      { name: 'Cielo',  hex: '#b3c8db' },
      { name: 'Pietra', hex: '#c7bfa8' },
    ],
  },
  {
    id: 'cotton-tee',
...
function saveCart() {
  ...
  sessionStorage.setItem('baggio_cart', JSON.stringify(serialisable));
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('fine').textContent =
    '© ' + new Date().getFullYear() + ' BAGGIO. Malla, Beirut · Delivery all over Lebanon.';
